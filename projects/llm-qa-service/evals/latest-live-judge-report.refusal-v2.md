...
- 生成时间（UTC）：2026-09-02T14:33:04.411818+00:00
...
| Unanswerable source-grounded refusal rate | 50.0% |
| Mean generation latency | 1464.77 ms |
| P95 generation latency | 1809.71 ms |
...
| Mean judge latency | 1656.32 ms |
| P95 judge latency | 2190.62 ms |

## Generation cases requiring review（具体失败回答）

| ID | Question | Issues | Answer | LLM judge note |
|---|---|---|---|---|
| unknown-dinner-allowance | 晚餐报销额度的上限是多少？ | 未命中资料不足的拒答规则 | 根据资料，出差住宿标准中，一线城市每晚不超过 800 元，二线城市不超过 500 元。但资料中未明确提及“晚餐报销额度”的具体上限。 [资料1] [资料2] | 候选回答准确指出资料未提供晚餐报销额度，未编造事实，且明确说明资料无答案。 |
